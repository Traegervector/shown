...
export let getFileByDriveId = () => html`
    <mgt-file
...
export let getFileByGroupId = () => html`
...
export let getFileByListId = () => html`
    <mgt-file
...
export let getSignedinUserFiles = () => html`
...
export let getFileBySiteId = () => html`
    <mgt-file
...
export let getFileByUserId = () => html`
...
export let getFileByInsights = () => html`
    <mgt-file
      insight-type="shared"
...
export let changeLineProperties = () => html`
    <mgt-file
      file-query="/me/drive/items/01BYE5RZZFWGWWVNHHKVHYXE3OUJHGWCT2"
...
export let supplyDriveItem = () => html`
    <mgt-file
      class="my-file"
      line1-property="lastModifiedDateTime"
      line2-property="name"
...
// export let mediaQuery = () => html`
//   <mgt-file file-query="/me/drive/items/01BYE5RZZFWGWWVNHHKVHYXE3OUJHGWCT2"></mgt-file>
//   <p id="file-media-query">Getting media query</p>
//     <script>
//       let mediaQuery = document.querySelector('mgt-file').ComponentMediaQuery;
//       console.log(mediaQuery)
//       let display = document.getElementById("file-media-query");
